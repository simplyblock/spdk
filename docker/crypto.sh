...
sed -i 's/^\tadr\s\+sha1key_adr, KEY_1$/\tadrp    sha1key_adr, KEY_1\
\tadd     sha1key_adr, sha1key_adr, :lo12:KEY_1/' /root/spdk/isa-l-crypto/mh_sha1/aarch64/sha1_asimd_common.S

sed -i 's/^\tadr\s\+sha1key_adr, KEY_2$/\tadrp    sha1key_adr, KEY_2\
\tadd     sha1key_adr, sha1key_adr, :lo12:KEY_2/' /root/spdk/isa-l-crypto/mh_sha1/aarch64/sha1_asimd_common.S
