...
int vbdev_lvol_create_hublvol(struct spdk_lvol_store *lvs, const char *name, spdk_lvol_op_with_handle_complete cb_fn, void *cb_arg);
...
bool lvol_delete_requests_contains(struct spdk_lvol *lvol);
